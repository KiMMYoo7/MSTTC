...
<div class="container">
    <div class="card">
        ...
        <form method="post" action="DeleteNews.php">
                <label for="IdNews" style="text-align: left;">Enter ID News</label>
                <input type="text" name="IdNews" id="IdNews" value="<?php echo isset($IdNews) ? htmlspecialchars($IdNews) : ''; ?>">
    ...
    <h3>News Details</h3>
    <form action="inputDeleteNews.php" method="post" enctype="multipart/form-data">
        ...
        <table align="center" border="1" cellpadding="10">
            ...
            <tr>
                ...
                <td><?php echo htmlspecialchars($news['ShortDescription']); ?></td>
            </tr>
            <tr>
                <td><strong>News Date</strong></td>
                <td><?php echo htmlspecialchars($news['NewsDate']); ?></td>
            </tr>
        </table>
